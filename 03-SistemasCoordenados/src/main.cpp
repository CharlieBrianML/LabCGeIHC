...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//glViewport(0, 0, screenWidth/2, screenHeight/2);////Dibuja en cierto cuadrante, hay que probar
	glViewport(0, 0, screenWidth, screenHeight);/////////HACER REPORTE HASTA EL PUNTO 2-EJERCICIOS
	...
	{		//Cara frontal 
			...
			{ glm::vec3(0.5f, 0.5f, -0.5f), glm::vec3(0.0f, 1.0f, 0.0f) },
			{ glm::vec3(0.5f, 0.5f,  0.5f), glm::vec3(0.0f, 1.0f, 0.0f) },
	};/////TAREA: MOdulado del cubo mostrando todas sus caras con un color diferente
	...
	GLuint indices2[] = {  // Note que se inicia en 0! //////////////////////////////////////////
	0, 1, 2,
	0, 2, 3,
	4, 5, 6,
	4, 6, 7,
...
void applicationLoop() {
	...
	while (psi) {
		...
		//variando el angulo le aleja y se acerca
		glm::mat4 projection = glm::perspective(glm::radians(90.0f), (float)screenWidth / (float)screenHeight, 0.2f, 100.0f);//se declara la matriz en perspectiva
		...
		//model = glm::translate("model",false,glm::vet3(-1.0,1.0,-4.0));///
		...
		//model = glm::translate(glm::mat4(1.0), glm::vet3(-2.0.0.0, -4.0));
