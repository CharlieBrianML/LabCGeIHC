...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//Compilación de Fragmente Shader
	glCompileShader(fragmentShaderID);
	//Se obtiene el estatus de la compilación del Fragment sahder
	glGetShaderiv(fragmentShaderID, GL_COMPILE_STATUS, &success);
	if (!success) {
		//En caso de error se obtiene el error y lanza mensaje con error
		glGetShaderInfoLog(fragmentShaderID, 512, NULL, infoLog);
		std::cout << "Error al compilar el FRAGEMENT_SHADER." << infoLog << std::endl;
	}
	...
	Vertex vertices[] = {
		...
		{{0.0,0.7,0.0},{0.5,0.3,0.7}},///
		{{0.0,0.8,0.0},{0.4,0.1,0.8}},///
		{{0.0,0.0,0.0},{0.2,0.3,0.5}},///
		{{-0.7,0.2,0.0},{0.2,0.3,0.7}},///
		{{-0.7,0.0,0.0},{0.5,0.4,0.1}},///
		{{0.0,0.0,0.0},{0.2,0.3,0.5}},///
		{{-0.7,0.2,0.0},{0.5,0.3,0.7}},///
		{{-0.7,0.0,0.0},{0.2,0.4,0.1}},///
		{{0.0,0.0,0.0},{0.7,0.3,0.5}},///
		{{0.0,-0.7,0.0},{0.7,0.3,0.5}},///
		{{-0.2,-0.7,0.0},{0.7,0.3,0.5}},///
	};
	...
	*/
	...
	// indice del atributo, Cantidad de datos, Tipo de dato, Normalizacion, Tamanio del bloque (Stride), offset (Apuntador al desplazamiento)
...
void applicationLoop() {
	...
	while (psi) {
		...
		glDrawArrays(GL_TRIANGLES, 0,40);/// trinagulo lab
		glBindVertexArray(0);
